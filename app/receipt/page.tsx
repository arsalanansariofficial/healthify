...
export default function AppointmentReceipt() {
  return (
    <main className="row-start-2 grid place-items-center">
      <section className="max-w-fit font-serif font-semibold">
        <div className="space-y-4">
          <h1 className="font-sans- mx-auto w-4/5 text-center text-xl capitalize">
            Your appointment has been confirmed.
          </h1>
          <div className="mx-auto h-5 rounded-md border-5 shadow" />
        </div>
        <div className="overflow-hidden">
          <Card className="print-animation mx-auto mt-4">
            <CardContent className="grid min-h-50 grid-cols-2 gap-2">
          ...
          <Card className="print-animation mx-auto border-t border-dashed">
            <CardContent className="grid grid-cols-[3em_1fr] gap-2">
              <svg
                viewBox="0 0 29.938 29.938"
                xmlns="http://www.w3.org/2000/svg"
                className="bg-foreground rounded-md p-1"
              >
